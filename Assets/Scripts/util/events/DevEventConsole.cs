...
//      I-------------------------------------------------------------------------------I
//      I-----I-I-------I-------I-------I-----------------------I-------I-------I-------I
//  3.1 I 3.0 I I  3.3  I  3.2  I  3.3  I     <-   3.4   -->    I  3.5  I  3.6  I  3.7  I
//      I-----I-I-------I-------I-------I-----------------------I-------I-------I-------I
//      I-----I-I-------I-------I-------I-----------------------I-------I-------I-------I
//  3.2 I 3.0 I I  3.3  I  3.2  I  3.3  I     <-   3.4   -->    I  3.5  I  3.6  I  3.7  I
//      I-----I-I-------I-------I-------I-----------------------I-------I-------I-------I
//      I-----I-I-------I-------I-------I-----------------------I-------I-------I-------I
//  3.3 I 3.0 I I  3.3  I  3.2  I  3.3  I     <-   3.4   -->    I  3.5  I  3.6  I  3.7  I
//      I-----I-I-------I-------I-------I-----------------------I-------I-------I-------I
//      I-------------------------------------------------------------------------------I
...
public class DevEventConsole : EditorWindow {
    ...
    private void DrawUpperPanel() {
        ...
        // Draw boxed test:
        //LoopDevEvents();
        DrawDevEventBox("[23:47:14]", DevEventType.Gamemode, "'Follow' GAMEMODE SELECTED", "Hello, World EXTRA!", true, false);
        DrawDevEventBox("[23:47:14]", DevEventType.Time, "GAME TIMER CHANGED TO '00:60'", "EXTRA", false, false);
        DrawDevEventBox("[23:47:14]", DevEventType.Crosshair, "CROSSHAIR GAP CHANGED TO '6", "CROSSHAIR EXTRA", true, false);
        DrawDevEventBox("[23:47:14]", DevEventType.Targets, "[Scatter] NEW PRIMARY TARGET SPAWN: (13,42,90).", "Targets EXTRA", false, false);
        DrawDevEventBox("[23:47:14]", DevEventType.Interface, "FPS Counter WIDGET TOGGLE SET", "Interface EXTRA", true, false);
        DrawDevEventBox("[23:47:14]", DevEventType.Save, "'Cosmetics' SETTINGS SAVED", "Save EXTRA", false, false);
    ...
    private void DrawLowerPanel() {
        ...
        showCrosshair = GUILayout.Toggle(showCrosshair, new GUIContent("Crossahair", DevEventUtil.crosshairBarLeft), EditorStyles.toolbarButton);
        GUILayout.Space(5f);
        showTargets = GUILayout.Toggle(showTargets, new GUIContent("Targets", DevEventUtil.targetsBarLeft), EditorStyles.toolbarButton);
        //GUILayout.FlexibleSpace();
        GUILayout.EndHorizontal();
        GUILayout.EndArea();
        ...
        GUILayout.BeginHorizontal();
        showInterface = GUILayout.Toggle(showInterface, new GUIContent("Interface", DevEventUtil.interfaceBarLeft), EditorStyles.toolbarButton);
        GUILayout.Space(5f);
        showSave = GUILayout.Toggle(showSave, new GUIContent("Save", DevEventUtil.saveBarLeft), EditorStyles.toolbarButton);
        GUILayout.Space(5f);
        showSkybox = GUILayout.Toggle(showSkybox, new GUIContent("Skybox", DevEventUtil.skyboxBarLeft), EditorStyles.toolbarButton);
        GUILayout.Space(5f);
        showLanguage = GUILayout.Toggle(showLanguage, new GUIContent("Language", DevEventUtil.languageBarLeft), EditorStyles.toolbarButton);
        ...
        GUILayout.BeginHorizontal();
        showKeybind = GUILayout.Toggle(showKeybind, new GUIContent("Keybind", DevEventUtil.keybindBarLeft), EditorStyles.toolbarButton);
        GUILayout.Space(5f);
        showSound = GUILayout.Toggle(showSound, new GUIContent("Sound", DevEventUtil.soundBarLeft), EditorStyles.toolbarButton);
        GUILayout.Space(5f);
        showNotification = GUILayout.Toggle(showNotification, new GUIContent("Notification", DevEventUtil.notificationBarLeft), EditorStyles.toolbarButton);
        GUILayout.Space(5f);
        showStats = GUILayout.Toggle(showStats, new GUIContent("Stats", DevEventUtil.statsBarLeft), EditorStyles.toolbarButton);
        //GUILayout.FlexibleSpace();
        GUILayout.EndHorizontal();
        GUILayout.EndArea();
